...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/wishlist', [wishlist::class, 'showWishlist'])->name('/wishlist');
    Route::post('/addToWishlist/{id}', [wishlist::class, 'addToWishlist'])->name('/addToWishlist');
    Route::delete('/deleteFromWishlist/{id}', [wishlist::class, 'deleteFromWishlist'])->name('/deleteFromWishlist');
});
